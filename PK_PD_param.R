...
DL_kg=matrix(data=c(
  ...
  10,25,50,rep(75,4),
  10,25,50,rep(100,4),
  10,25,50,100,rep(150,3),
  25,50,100,rep(150,4),
  25,50,100,150,rep(200,3),
  25,50,100,rep(250,4),
  25,50,100,rep(300,4),
  25,50,100,200,rep(400,3),
  50,100,200,400,rep(500,3),
  50,100,200,400,rep(600,3),
  50,100,200,400,600,rep(800,2),
  100,200,400,600,rep(800,3)
),ncol=7,byrow=T)
DL_kg=DL_kg[c(1,2,3,4,6,7,8,9,10,11),]
