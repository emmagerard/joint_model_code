...
c_infusion_1cpt_multiple=function(t,doses,t_doses,
                                  t_inf,
                                  PK_param_individual){
...
simu_individual_param=function(pop_param=list(mu,w)){
...
extract_max=function(R,time,doses,t_doses){
...
PK_PD_simu_Rmax_local=function(t,
                               doses,
                               t_doses,
                               t_inf,
                               PK_model,
...
PK_PD_simu_Rmax_local_ind=function(t,
                               doses,
                               t_doses,
                               t_inf,
                               PK_model,
